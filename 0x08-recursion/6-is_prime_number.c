 ...
 * @guess: the number to check if the result of it's square root returns a remainder 0 or not
 * Description: This approach actually makes use of what we call the Trial division method
